...
$var3="http://www.creaservices.be/kleinvossenpark/img/logo-klein.jpg"; //locatie logo
...
$mailemail="info@kleinvossenpark.be";
//////////////////////////////////////////////////////////////////////////////////
...
if($opslaan=='1')
{
    ...
    $mailonderwerp="Nieuwsbrief aanvraag van ".$naam;
	$mailbericht="<html>
						<head>
  							<title>".$var1."</title>
						...
						<tr><td>
						<font color='".$var4."' face='Geneva, Arial, Helvetica, sans-serif' size='5'>Nieuwsbrief aanvraag van ".$naam.".</font>
						</td></tr>
						<tr><td><font color='".$var5."' face='Geneva, Arial, Helvetica, sans-serif' size='2'>Volgende persoon heeft zich ingeschreven voor de nieuwsbrief van  ".$var6.".</font></td>
						<tr>
						</table>
						<table width='550' border='0' cellspacing='0' cellpadding='8'>
						<tr align='left'>
						  ...
						  <table width='550' border='0' cellspacing='0' cellpadding='8'>
						  <tr><td>
						<font color='".$var5."' face='Geneva, Arial, Helvetica, sans-serif' size='2'><br/>Wij danken u voor uw aanvraag. <br/><br/> Met vriendelijke groeten </font><br/> <strong><font color='".$var13."' face='Geneva, Arial, Helvetica, sans-serif' size='3'>".$var12."</strong></font>
						<td><tr>
						</table>
						</body>
						</html>";                 
	...
	$headers .= "From: ".$email." \r\n";
	$headers .= "Cc: ".$email." \r\n";
	$headers .= "Bcc: frank@creaservices.be" . "\r\n";
